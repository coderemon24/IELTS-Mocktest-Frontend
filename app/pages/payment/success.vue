    ...
    <div class="container mx-auto px-4 py-12">
      <div class="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-2xl font-bold text-navy">Payment successful</h1>
            <p class="text-sm text-slate-500">Your subscription is now active.</p>
          </div>
        </div>
        ...
        <div v-else-if="order" class="mt-6">
          <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="bg-slate-50 rounded-2xl p-4">
              ...
              <p class="font-bold text-emerald-600">{{ order.status }}</p>
            </div>
            <div class="bg-slate-50 rounded-2xl p-4">
          ...
          <div class="mt-6 flex flex-col sm:flex-row gap-3">
            <NuxtLink to="/my/subscriptions" class="flex-1 text-center bg-navy text-white font-bold py-3 rounded-xl hover:bg-navy-light transition">
